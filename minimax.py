...
# Evaluation function: takes in a state of the game (board arrangement)
# and boils it down to a real number evaluation of the state. 
# Ex: function gives higher scores to board states in which the player
# of interest has more of their pieces on the board then the opponent
